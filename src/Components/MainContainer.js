...
function MainContainer({ labels, values, style }) {
  return (
    <animated.div style={style} className="animatedContainer">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  $
                  {values[1]
                    ? String(values[1]).replace(/(.)(?=(\d{3})+$)/g, "$1,")
                    : "-"}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  {values[10]
                    ? String(values[10]).replace(/(.)(?=(\d{3})+$)/g, "$1,")
                    : "-"}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  {values[11]
                    ? String(values[11]).replace(/(.)(?=(\d{3})+$)/g, "$1,")
                    : "-"}
                </td>
              </tr>
            </tbody>
